...
template<class Type>
bool orderedLinkedListType<Type>::search(const Type& searchItem) const {
	bool found = false;
...
template<class Type>
void orderedLinkedListType<Type>::insert(const Type& newItem) {
	nodeType<Type> *current; //pointer to traverse the list
...
template<class Type>
void orderedLinkedListType<Type>::insertFirst(const Type& newItem) {
	insert(newItem);
}                       //end insertFirst

template<class Type>
void orderedLinkedListType<Type>::insertLast(const Type& newItem) {
	insert(newItem);
}                       //end insertLast
...
template<class Type>
void orderedLinkedListType<Type>::deleteLeastInfo() {
...
template<class Type>
void orderedLinkedListType<Type>::deleteAllOccurrencesOfInfo(const Type& deleteItem) {
	nodeType<Type> *current; //pointer to traverse the list
